...
import command.AdditionFunctions;
...
public class Organization implements Comparable <Organization>, Serializable {
    ...
    public void setParameters(Organization newOrganization) {
        this.setName(newOrganization.getName());
        this.setCoordinates(newOrganization.getCoordinates());
        this.setCreationDate(newOrganization.getCreationDate());
        this.setAnnualTurnover(newOrganization.getAnnualTurnover());
        this.setType(newOrganization.getType());
        this.setAddress(newOrganization.getAddress());
    }
